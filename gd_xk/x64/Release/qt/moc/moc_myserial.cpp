...
QT_MOC_LITERAL(1, 9, 22), // "sig_hasPendingDatagram"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 4), // "data"
QT_MOC_LITERAL(4, 38, 12), // "sendDatagram"
QT_MOC_LITERAL(5, 51, 18) // "hasPendingDatagram"

    },
    "MySerial\0sig_hasPendingDatagram\0\0data\0"
    "sendDatagram\0hasPendingDatagram"
};
...
void MySerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendDatagram((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySerial::sig_hasPendingDatagram)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MySerial::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_MySerial.data,
...
// SIGNAL 0
void MySerial::sig_hasPendingDatagram(QByteArray _t1)
{
